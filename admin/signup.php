	...
	if(Token::check(Input::get('token')))
	{
		...
		try{
			...
			die($e->getMessage());
				...
				Session::flash('Home', 'You have successfully registered a new Administrator');
...
<div class="col-md-6">
		...
		<div class="col-md-6">
				...
				<div class="form-group">
				<div class="">
					<input type="submit" id="submit" value="Register Administrator" class="btn btn-primary col-md-12">
